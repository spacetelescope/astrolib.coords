...
extern "C" {
#endif
static PyObject *_wrap_blackbox(PyObject *self, PyObject *args) {
...
static PyMethodDef SwigMethods[] = {
	 { (char *)"blackbox", _wrap_blackbox, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
SWIGEXPORT void SWIG_init(void) {
    ...
    {
        PyDict_SetItemString(d,"b1950", SWIG_From_double((double)((2433282.42345905)))); 
    }
    {
        PyDict_SetItemString(d,"j2000", SWIG_From_double((double)((2451545.0)))); 
    }
    {
        PyDict_SetItemString(d,"CJ", SWIG_From_double((double)((36525.0)))); 
    }
    {
        PyDict_SetItemString(d,"CB", SWIG_From_double((double)((36524.21987817305)))); 
    }
    {
        PyDict_SetItemString(d,"s01", SWIG_From_int((int)(1))); 
    }
    {
        PyDict_SetItemString(d,"s02", SWIG_From_int((int)(2))); 
    }
    {
        PyDict_SetItemString(d,"s03", SWIG_From_int((int)(3))); 
    }
    {
        PyDict_SetItemString(d,"s04", SWIG_From_int((int)(4))); 
    }
    {
        PyDict_SetItemString(d,"s05", SWIG_From_int((int)(5))); 
    }
    {
        PyDict_SetItemString(d,"s06", SWIG_From_int((int)(6))); 
    }
}
